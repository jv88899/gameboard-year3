...
const TransactionList = ({ activeStep, canHighlightCashTransactions }) => {
  const [transactions, setTransactions] = useState([
    ...
    },
    {
      ...
      route: `010`,
      description: `Receive claim for $18 of actual medical visits after renegotiating contracts with providers`,
      activeStep: null,
      previousStep: null,
      visible: true,
      isCashTransaction: false
    ...
    },
    {
      ...
      route: `015`,
      description: `Pay actual claims of $1 received in Year 3 for Year 2 (IBNR Estimate was $3); less than expected`,
      activeStep: null,
      previousStep: null,
      visible: true,
      isCashTransaction: false
    ...
    },
    {
      ...
      route: `029`,
      description: `Use 1/5 of 401 and 301 Carlson Parkway buildings for Year 3`,
      activeStep: null,
      previousStep: null,
      visible: true,
      isCashTransaction: false
